-- CreateEnum
CREATE TYPE "FamilyMode" AS ENUM ('SOLO', 'COUPLE');

-- CreateEnum
CREATE TYPE "FamilyRole" AS ENUM ('ADMIN', 'MEMBER');

-- CreateEnum
CREATE TYPE "IncomeType" AS ENUM ('PRIMARY', 'SECONDARY', 'SIDE');
...
CREATE TABLE "Family" (
    ...
    "mode" "FamilyMode" NOT NULL DEFAULT 'COUPLE',
    "createdAt" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP,
    "updatedAt" TIMESTAMP(3) NOT NULL,
...
CREATE TABLE "Category" (
    "id" TEXT NOT NULL,
    "name" TEXT NOT NULL,
    "color" TEXT NOT NULL DEFAULT '#C9922B',
    "icon" TEXT,
    "familyId" TEXT NOT NULL,
    "createdAt" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP,
    "updatedAt" TIMESTAMP(3) NOT NULL,
...
-- CreateIndex
CREATE INDEX "SubCategory_managerId_idx" ON "SubCategory"("managerId");
...
-- AddForeignKey
ALTER TABLE "SubCategory" ADD CONSTRAINT "SubCategory_managerId_fkey" FOREIGN KEY ("managerId") REFERENCES "User"("id") ON DELETE SET NULL ON UPDATE CASCADE;
